...
urlpatterns = [
    ...
    url(r'^type_in/', views.grademanageview.as_view()),
    url(r'^submit/', views.changescoreview.as_view()),
    ...
    url(r'^admake/', views.admakeview.as_view()),
    url(r'^tsearch/', views.tsearchview.as_view()),
    url(r'^tdelete/', views.tdeleteview.as_view()),
    url(r'^showsgpa/', views.showsgpaview.as_view()),
    url(r'^showrank/', views.showrankview.as_view()),
    url(r'^grademanage/', views.grademanageview.as_view()),
    url(r'^changescore/', views.changescoreview.as_view()),
